...
const Checks = () => {
  ...
  return (
    <>
      ...
      >
        <Button
          href={`${process.env.reactBootstrapDocsUrl}/forms/checks-radios`}
          target="_blank"
          variant="link"
          size="sm"
          className="ps-0"
      ...
      <FalconComponentCard>
        <FalconComponentCard.Header title="Custom rendering" light={false}>
          ...
          <p className="mb-0">
            ...
            can forgo the default rendering and handle it yourself. (You can
            still provide an <code>id</code> to the <code>FormCheck</code> or{' '}
